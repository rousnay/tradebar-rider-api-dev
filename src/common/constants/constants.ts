export const AppConstants = {
  app: {
    name: 'CGP Rider API' as const,
    version: '1.0.0' as const,
    description:
      'OpenAPI Specification for CGP Rider API developed by Revinr' as const,
  },
  cloudflare: {
  ...
  stripe: {
    ...
    success_url: 'https://cgp-rider-api.onrender.com' as const,
    cancel_url: 'https://cgp-rider-api.onrender.com' as const,
  },
  mail: {
