...
export class AuthController {
  ...
  @Post('registration')
  @ApiOperation({ summary: 'Rider registration' })
  @ApiBody({
    description: 'Rider registration data',
    examples: {
      credentials: {
    ...
    examples: {
      credentials: {
        ...
        value: {
          ...
          device_token: 'fq-Gq6wxTJqb-luPyicKRo:APA91bGhzPf1nRz_DYQA3M5WFGQfoD9ufPlMlwK4yay',
        },
      },
    },
  })
  ...
  @ApiBody({
    description: 'Rider login credentials',
    examples: {
      credentials: {
